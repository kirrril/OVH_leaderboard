...
public class LogInManager : MonoBehaviour
{
    ...
    public void LaunchSignIn(string player_name, string password)
    {
        StartCoroutine(SignInCoroutine(player_name, password));
    }

    private IEnumerator SignInCoroutine(string player_name, string password)
    {
        baseText = "Logging in";
